...
export interface DashboardStats {
  ...
  content: { achievements: number; faqs: number; faqsPublished: number; faqCategories: number; pages: number; tickers: number };
  studentAchievements: { total: number; published: number };
  boardMembers: { total: number; executive: number; organizational: number };
