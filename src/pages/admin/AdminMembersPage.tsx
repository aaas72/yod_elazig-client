              ...
              <FormInput 
                ...
                footer={typeof editForm.profileImage === 'string' && editForm.profileImage ? (
                   <div className="mt-1 flex items-center gap-3 px-1">
                     ...
                     />
                     <a 
                       href={editForm.profileImage.startsWith('http') ? editForm.profileImage : `${BASE_URL}${editForm.profileImage.startsWith('/') ? '' : '/'}${editForm.profileImage}`} 
                       target="_blank" 
              ...
              <FormInput
                ...
                footer={typeof editForm.studentDocument === 'string' && editForm.studentDocument ? (
                   <div className="mt-1 flex items-center gap-2 px-1">
                     <a 
                     href={editForm.studentDocument.startsWith('http') ? editForm.studentDocument : `${BASE_URL}${editForm.studentDocument.startsWith('/') ? '' : '/'}${editForm.studentDocument}`} 
                     target="_blank" 
                     rel="noopener noreferrer" 
                       className="text-sm text-blue-600 hover:underline flex items-center gap-1" 
                       dir="ltr"
