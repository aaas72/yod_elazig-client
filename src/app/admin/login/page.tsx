...
function LoginForm() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-red-900 via-gray-800 to-gray-900 text-white" dir="rtl">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto flex items-center justify-center min-h-screen px-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pl-8 bg-white/10 border text-white border-white/20 rounded-xl placeholder-gray-400 placeholder:text-sm focus:ring-2 focus:ring-white focus:border-transparent outline-none transition-all"
                  dir="rtl"
                />
                <button
                  type="button"
