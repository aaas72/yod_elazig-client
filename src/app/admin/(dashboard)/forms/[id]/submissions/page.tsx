...
import { ArrowRight, Download, Eye, Upload } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4 mb-6">
        <button onClick={() => router.push('/admin/forms')} className="p-2 hover:bg-gray-100 rounded-full"><ArrowRight size={20} /></button>
