...
import { Edit, Trash2, Eye, Plus, X, FileText } from 'lucide-react';
      ...
      <AdminDataTable
        ...
        actions={(item) => (
          <div className="flex gap-1">
            ...
            <button onClick={() => router.push(`/admin/forms/${item._id}/submissions`)} className="p-1.5 hover:bg-gray-100 rounded text-blue-600" title="الاستجابات"><FileText size={16} /></button>
